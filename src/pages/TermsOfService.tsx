...
export const TermsOfService = () => {
  return (
    <ToolLayout
      ...
      description="Read the terms and conditions for using ByteToolbox. Simple, clear, and developer-friendly terms."
    >
      <div className="p-6 max-w-4xl mx-auto">
        <div className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ByteToolbox is open source and available under the MIT License. You may view, 
              modify, and distribute the source code according to the terms of the MIT License.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-card border border-border rounded-lg p-4 mt-4">
              <p className="text-foreground">
                <strong>Email:</strong> legal@bytetoolbox.com<br />
          ...
          <div className="bg-info/10 border border-info/20 rounded-lg p-4 mt-8">
            <h3 className="font-semibold text-info mb-2">🤝 Developer-Friendly Terms</h3>
